...
function VideoListLink(props){
	...
	return(
		<>
			<div className="col-6 pr-3 pt-3 pb-3">
	         <div className="wrap">
					<div className="image_effect">
						<Link href={videourl}>
							<img className="d-block w-100" src={obj.video_thumbnail} alt={obj.title} />
						</Link>
					</div>
		       	<div className="youtube-play-small">
		          	<Link href={videourl}>
		             <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="play-circle" className="svg-inline--fa fa-play-circle fa-w-16 text-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
