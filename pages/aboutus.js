...
export default function AboutUs({ gethometopsection, getrighdata }) {
                           ...
                           <div className="col-12">
                              <div className="row mt-3 mb-3">
                                 <div className="col-12"><b className="font24px position-relative">
                                    ...
                                    <Link className="ml-4" href="/aboutus">About us</Link></b></div>
                                 <div className="col-12">
...
export async function getStaticProps() {
  const res = await fetch(ApiUrl+"getaboutus/")
