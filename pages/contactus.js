...
export default function Contactus({ gethometopsection, getrighdata }) {
               ...
               <Left />
                  ...
                  <div className="col-md-6 bg-white mt-3">
                     <div className="container-fluid p-3">
                        ...
                        <ContactusForm title="अपने सुझाव हमें भेजें" type="contactus" />
                     </div>
                  </div>
...
export async function getStaticProps() {
  const res = await fetch(ApiUrl+"getcontactus/")
